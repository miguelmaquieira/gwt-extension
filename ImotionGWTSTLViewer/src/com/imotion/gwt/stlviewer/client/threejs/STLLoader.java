...
public class STLLoader {
	...
	public native static final void load(String url, AsyncCallback<Geometry> callback) /*-{
		...
		loader.addEventListener( 'load', function ( event ) {
			...
			@com.imotion.gwt.stlviewer.client.threejs.STLLoader::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/akjava/gwt/three/client/core/Geometry;)(callback, geometry);
		} );
		loader.load(url);
	}-*/;
