...
public interface CRONIOBOIPreferencesDataConstants {
	...
	String PREFERENCES_USER_PROPERTIES			= "userPreferences";
	String DOWNTIME								= "downTime";
	String PREFERENCES_USER_PROPERTIES_PREFFIX	= PREFERENCES_USER_PROPERTIES + AEMFTIBusinessConstant.CTE_MFT_AE_BUS_SERVICE_ID_SEPARATOR;
	String PREFERENCES_USER_PROPERTIES_DOWNTIME = PREFERENCES_USER_PROPERTIES_PREFFIX + DOWNTIME;
