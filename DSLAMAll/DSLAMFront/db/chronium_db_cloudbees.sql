CREATE DATABASE  IF NOT EXISTS `cb_chronium-io-db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `cb_chronium-io-db`;
-- MySQL dump 10.13  Distrib 5.5.38, for debian-linux-gnu (i686)
--
-- Host: localhost    Database: cb_chronium-io-db
-- ------------------------------------------------------
...
/*!40000 ALTER TABLE `CRONIOBOProcess_scheduleList` DISABLE KEYS */;
