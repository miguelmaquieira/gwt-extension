...
import com.imotion.dslam.front.business.client.CRONIOBusBaseAppController;
import com.imotion.dslam.front.business.client.CRONIOBusBaseAppControllerConstants;
...
import com.imotion.dslam.front.business.desktop.client.flow.CRONIOBusDesktopAppFlowController;
import com.imotion.dslam.front.business.desktop.client.presenter.execution.CRONIOBusDesktopExecutionPresenter;
import com.imotion.dslam.front.business.desktop.client.presenter.log.CRONIOBusDesktopLogPresenter;
...
import com.imotion.dslam.front.business.desktop.client.presenter.projectpage.CRONIOBusDesktopProjectPagePresenter;
import com.imotion.dslam.front.business.desktop.client.presenter.scriptsmanager.CRONIOBusDesktopScriptsManagerPresenter;
import com.imotion.dslam.front.business.desktop.client.view.execution.CRONIOBusDesktopExecutionScreenView;
import com.imotion.dslam.front.business.desktop.client.view.info.CRONIOBusDesktopInfoScreenView;
import com.imotion.dslam.front.business.desktop.client.view.log.CRONIOBusDesktopLogScreenView;
...
import com.imotion.dslam.front.business.desktop.client.view.projectpage.CRONIOBusDesktopProjectPageScreenView;
import com.imotion.dslam.front.business.desktop.client.view.scriptsmanager.CRONIOBusDesktopScriptsManagerScreenView;
...
public class CRONIOBusDesktopAppController extends CRONIOBusBaseAppController {
	...
	public void loadJS(Callback<Void, Exception> callback) {
		...
		bootstrapLibraries.add(CRONIOBusBaseAppControllerConstants.JQUERY_JS_URL);
		bootstrapLibraries.add(CRONIOBusBaseAppControllerConstants.JQUERY_MOUSE_WHEEL_JS_URL);
		bootstrapLibraries.add(CRONIOBusBaseAppControllerConstants.JQUERY_PERFECT_SCROLLBAR_JS_URL);
		bootstrapLibraries.add(CRONIOBusBaseAppControllerConstants.BOOTSTRAP_JS_URL);
		bootstrapLibraries.add(CRONIOBusBaseAppControllerConstants.JQUERY_DATETIMEPICKER_JS);
		bootstrapLibraries.add(CRONIOBusBaseAppControllerConstants.BOOTSTRAP_FILESTYLE_JS);
	...
	protected AEGWTIPresenter getPresenter(String[] tokenElements) {
		...
		if (AEGWTStringUtils.isEmptyString(token1)) {
			token1 = CRONIOBusDesktopHistoryNavigationConstants.TOKEN_PROJECT_PAGE;
		}
		...
		if (AEGWTStringUtils.isEmptyString(sid)) {
			...
			if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_SCRIPTS_MANAGER.equals(token1) ) {
				presenter = new CRONIOBusDesktopScriptsManagerPresenter(new CRONIOBusDesktopScriptsManagerScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_PROJECT_PAGE.equals(token1) ) {
				presenter = new CRONIOBusDesktopProjectPagePresenter(new CRONIOBusDesktopProjectPageScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_PROCESS_PAGE.equals(token1) ) {
				presenter = new CRONIOBusDesktopProcessPresenter(new CRONIOBusDesktopProcessScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_EXECUTION.equals(token1) ) {
				presenter = new CRONIOBusDesktopExecutionPresenter(new CRONIOBusDesktopExecutionScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_PREFERENCES.equals(token1) ) {
				presenter = new CRONIOBusDesktopPreferencesPresenter(new CRONIOBusDesktopPreferencesScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_MACHINES.equals(token1) ) {
				presenter = new CRONIOBusDesktopPreferencesConnectionPresenter(new CRONIOBusDesktopPreferencesConnectionScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_USER.equals(token1) ) {
				presenter = new CRONIOBusDesktopPreferencesUserPresenter(new CRONIOBusDesktopPreferencesUserScreenView());
			} else if (CRONIOBusDesktopHistoryNavigationConstants.TOKEN_LOG.equals(token1) ) {
				presenter = new CRONIOBusDesktopLogPresenter(new CRONIOBusDesktopLogScreenView());
			} 
		}
		return presenter;
	}
	...
	protected AEGWTIFlowController createFlowController() {
		return new CRONIOBusDesktopAppFlowController(this, getView());
	}

	@Override
	protected AEGWTErrorDisplay getErrorScreenView() {
		return new CRONIOBusDesktopInfoScreenView(true);
	}
	...
	protected AEGWTBaseAppContextMapper createContextMapper() {
		return new CRONIOBusDesktopAppContextMapper(this);
	}
