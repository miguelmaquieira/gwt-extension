...
public class CRONIOBusDesktopPreferencesMenu extends AEGWTCompositePanel implements CRONIOBusPreferencesBasePresenterConstants {

	public static final String NAME = "CRONIOBusDesktopPreferencesMenu";
	...
	public CRONIOBusDesktopPreferencesMenu() {
		FlowPanel root = new FlowPanel();
		initWidget(root);
		root.addStyleName(CRONIOBusDesktopIStyleConstants.PREFERENCES_LAYOUT_MENU);
	...
	public void addConnection(String connectionName) {
		...
		String menuPathMachine = connection.getContainerId() + CRONIOBusCommonConstants.ELEMENT_SEPARATOR + connection.getId(); 

		//MENU -> Machines -> XXXX --> Connection Script
		CRONIOBusDesktopPreferencesMenuFinalItem connectionScript 		= new CRONIOBusDesktopPreferencesMenuFinalItem(menuPathMachine, CRONIOBOIMachinePropertiesDataConstants.MACHINE_CONNECTION_SCRIPT		,TEXTS.connection_script(), this);
		connection.add(connectionScript);

		//MENU -> Machines -> XXXX --> Disconnection Script
		CRONIOBusDesktopPreferencesMenuFinalItem disconnectionScript 	= new CRONIOBusDesktopPreferencesMenuFinalItem(menuPathMachine, CRONIOBOIMachinePropertiesDataConstants.MACHINE_DISCONNECTION_SCRIPT	,TEXTS.disconnection_script(), this);
		connection.add(disconnectionScript);

		//MENU -> Machines -> XXXX --> Machine Variables
		...
		//MENU -> Machines -> XXXX --> Connection Config
