...
import com.imotion.dslam.front.business.desktop.client.widget.projectpage.CRONIOBusDesktopNewProjectPopupForm;
...
public class CRONIOBusDesktopProjectsToolbarActions extends AEGWTCompositePanel {

	public static final String NAME = "CRONIOBusDesktopProjectsToolbarActions";
	...
	private	 CRONIOBusDesktopNewProjectPopupForm	projectPopupForm;
	private	 CRONIOBusDesktopExecutePopupForm		executePopupForm;

	public CRONIOBusDesktopProjectsToolbarActions() {
		FlowPanel root = new FlowPanel();
		initWidget(root);
		root.addStyleName(CRONIOBusDesktopIStyleConstants.TOOLBAR_ACTIONS);
		...
		optionButton.addStyleName(CRONIOBusDesktopIStyleConstants.TOOLBAR_ACTIONS_OPTIONS_BUTTON);
	...
	private CRONIOBusDesktopNewProjectPopupForm getProjectPopup() {
		if (projectPopupForm == null) {
			projectPopupForm = new CRONIOBusDesktopNewProjectPopupForm(this);
		}
