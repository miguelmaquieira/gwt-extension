...
public class CRONIOBusDesktopProjectsToolbar extends AEGWTCompositePanel {
	
	public static final String NAME = "CRONIOBusDesktopProjectsToolbar";
	
	private CRONIOBusDesktopProjectsToolbarActions 	projectActions;

	public CRONIOBusDesktopProjectsToolbar() {
		...
		projectActionsZone.addStyleName(CRONIOBusDesktopIStyleConstants.TOOLBAR_ACTIONS_ZONE);
	
		projectActions = new CRONIOBusDesktopProjectsToolbarActions();
	...
	public CRONIOBusDesktopProjectsToolbarActions getActions() {
