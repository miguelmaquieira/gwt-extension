package com.imotion.dslam.front.business.desktop.client.widget;
...
import com.imotion.dslam.front.business.client.view.controller.DSLAMI18NBusinessControllerTexts;
...
public class DSLAMBusNotLoggedScreenContainer extends AEGWTCompositePanel implements HasWidgets {
	...
	private static final DSLAMI18NBusinessControllerTexts 		BUSINESS_CONTROLLER_TEXTS 	= GWT.create(DSLAMI18NBusinessControllerTexts.class);
	
	private static NotLoguedScreenContainerUiBinder uiBinder = GWT.create(NotLoguedScreenContainerUiBinder.class);

	interface NotLoguedScreenContainerUiBinder extends UiBinder<Widget, DSLAMBusNotLoggedScreenContainer> {
	}
	...
	public DSLAMBusNotLoggedScreenContainer() {
