...
public abstract class DSLAMBusBasePresenter<T extends AEGWTCompositePanelLoggedViewDisplay> extends AEGWTBaseLoggedPresenter<T> implements AEGWTHasNavigationEventHandlers {

	
	public DSLAMBusBasePresenter(T view) {
		super(view);
	}
