...
public class CRONIOBusDesktopLoggerNodeInfoPanel extends AEGWTBootstrapPanelWithHeading {

	public static final String NAME = "CRONIOBusDesktopLoggerNodeInfoPanel";
	
	private static CRONIOBusI18NProcessTexts TEXTS = GWT.create(CRONIOBusI18NProcessTexts.class);
	
	public CRONIOBusDesktopLoggerNodeInfoPanel(String title) {
		super(title);
	}
	...
	public void setData(AEMFTMetadataElementComposite data) {
		...
		CRONIOBusDesktopLoggerNodeInfo nodeInfo = new CRONIOBusDesktopLoggerNodeInfo(nodeNameLabelText, nodeTypeLabelText, nodeIpLabelText, nodeWarningLabelText);
		setContent(nodeInfo);
	}
}