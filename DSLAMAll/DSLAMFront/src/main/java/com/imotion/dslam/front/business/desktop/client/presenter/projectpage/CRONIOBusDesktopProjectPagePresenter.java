...
public class CRONIOBusDesktopProjectPagePresenter extends CRONIOBusProjectBasePresenter<CRONIOBusDesktopProjectPageDisplay> {

	public static final String NAME = "CRONIOBusDesktopProjectPagePresenter";

	public CRONIOBusDesktopProjectPagePresenter(CRONIOBusDesktopProjectPageDisplay view) {
		super(view);
	}
