...
public interface CRONIOBusBaseAppControllerConstants {
	...
	public static final String DESKTOP_URI							= "CRONIODesktopModule.jsp";
	public static final String DESKTOP_URI_DEV						= DESKTOP_URI + GWT_DEV_SUFFIX;
	public static final String TOUCH_URI								= "CRONIOTouchModule.jsp";
	public static final String TOUCH_URI_DEV							= TOUCH_URI + GWT_DEV_SUFFIX;
	
	// STORE
	public static final String CRONIO_STORE							= "CRONIO_STORE";
	
	//JS
	public static final String BOOTSTRAP_JS_URL 					= "bootstrap-3.1.1-dist/js/bootstrap.min.js";
	public static final String JQUERY_DATETIMEPICKER_JS			= "js/jquery.datetimepicker.js";	
