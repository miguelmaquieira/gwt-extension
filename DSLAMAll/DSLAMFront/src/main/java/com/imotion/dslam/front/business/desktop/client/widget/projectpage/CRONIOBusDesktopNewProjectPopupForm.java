...
public class CRONIOBusDesktopNewProjectPopupForm extends AEGWTPopup {

	public static final String NAME = "CRONIOBusDesktopNewProjectPopupForm";
	...
	public CRONIOBusDesktopNewProjectPopupForm(AEGWTICompositePanel parent) {
		super(true, parent);
		FlowPanel root = new FlowPanel();
		setWidget(root);
		root.addStyleName(CRONIOBusDesktopIStyleConstants.NEW_PROJECT_FORM);

		//PROJECTNAME
		SimplePanel inputZone = new SimplePanel();
		root.add(inputZone);
		inputZone.addStyleName(CRONIOBusDesktopIStyleConstants.NEW_PROJECT_FORM_INPUT_ZONE);
		...
		saveButtonZone.addStyleName(CRONIOBusDesktopIStyleConstants.NEW_PROJECT_FORM_SAVE_ZONE);
