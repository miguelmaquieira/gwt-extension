...
public abstract class CRONIOBusBaseAppController extends AEGWTLoginAppController {

	private AEGWTIFlowController			flowController;
	private AEGWTBaseAppContextMapper		contextMapper;
	private CRONIOBusMessageWrapper			messageWrapper;
	...
	public String getModuleId() {
		return CRONIOBusPresenterBaseConstants.MODULE_ID;
	}
	
	@Override
	public String getApplicationName() {
		return CRONIOBusPresenterBaseConstants.APPLICATION_NAME;
	}
	...
	public AEGWTMessageWrapper getMessages() {
		if (messageWrapper == null) {
			messageWrapper = new CRONIOBusMessageWrapper();
		}
	...
	public String getApplicationStoreName() {
		return CRONIOBusBaseAppControllerConstants.CRONIO_STORE;
	}
