...
public class CRONIOBusDesktopProcessConfigureVariablesForm extends AEGWTPopup {

	public static final String NAME = "CRONIOBusDesktopProcessConfigureVariablesForm";
	...
	public CRONIOBusDesktopProcessConfigureVariablesForm(AEGWTICompositePanel parent) {
		super(true, parent);
		FlowPanel root = new FlowPanel();
		setWidget(root);
		root.addStyleName(CRONIOBusDesktopIStyleConstants.POPUP_VARIABLES_FORM_CONTAINER);
