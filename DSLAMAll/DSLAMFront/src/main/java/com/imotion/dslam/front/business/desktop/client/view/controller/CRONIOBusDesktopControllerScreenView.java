...
import com.imotion.dslam.front.business.client.presenter.controller.CRONIOBusControllerDisplay;
import com.imotion.dslam.front.business.desktop.client.view.CRONIOBusDesktopPanelBaseView;
import com.selene.arch.base.exe.core.appli.metadata.element.AEMFTMetadataElementComposite;

public class CRONIOBusDesktopControllerScreenView extends CRONIOBusDesktopPanelBaseView implements CRONIOBusControllerDisplay {

	public 		static String 				NAME	= "CRONIOBusDesktopControllerScreenView";
	private		static 	CRONIOBusI18NTexts	TEXTS 	= GWT.create(CRONIOBusI18NTexts.class);


	public CRONIOBusDesktopControllerScreenView() {
