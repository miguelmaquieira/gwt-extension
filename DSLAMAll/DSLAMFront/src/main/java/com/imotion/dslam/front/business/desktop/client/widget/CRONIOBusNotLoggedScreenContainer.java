...
import com.imotion.dslam.front.business.client.view.controller.CRONIOI18NBusinessControllerTexts;
...
public class CRONIOBusNotLoggedScreenContainer extends AEGWTCompositePanel implements HasWidgets {
	...
	interface NotLoguedScreenContainerUiBinder extends UiBinder<Widget, CRONIOBusNotLoggedScreenContainer> {
	}
	...
	public CRONIOBusNotLoggedScreenContainer() {
