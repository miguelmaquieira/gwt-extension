...
public class CRONIOBusDesktopLoggerNodeListElement extends AEGWTCompositePanel {
	...
	public CRONIOBusDesktopLoggerNodeListElement(final String nodeId, String nodeName, AEGWTCompositePanel parentWidget, boolean machineExist) {
		...
		menuItem = new CRONIOBusDesktopLoggerNodeFinalItem(nodeName, parentWidget, machineExist);
