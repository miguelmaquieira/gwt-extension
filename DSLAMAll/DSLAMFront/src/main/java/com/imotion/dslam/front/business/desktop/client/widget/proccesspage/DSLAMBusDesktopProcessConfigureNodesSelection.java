...
public class DSLAMBusDesktopProcessConfigureNodesSelection extends DSLAMBusDesktopPanelBaseView implements DSLAMBusDesktopProcessPageDisplay {
	...
	public DSLAMBusDesktopProcessConfigureNodesSelection() {
		...
		initWidget(root);
		addStyleName(DSLAMBusDesktopIStyleConstants.PROCESS_CONFIGURE_NODES_SELECTION);
