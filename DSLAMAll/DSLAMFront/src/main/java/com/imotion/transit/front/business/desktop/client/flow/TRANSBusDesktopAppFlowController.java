package com.imotion.transit.front.business.desktop.client.flow;
...
public class TRANSBusDesktopAppFlowController extends AEGWTBaseFlowController {

	public static final String NAME = "BusinessDesktopManagementAppFlowController";

	public TRANSBusDesktopAppFlowController(AEGWTIPresenter presenter, AEGWTCompositePanelViewDisplay display) {
		super(display);
