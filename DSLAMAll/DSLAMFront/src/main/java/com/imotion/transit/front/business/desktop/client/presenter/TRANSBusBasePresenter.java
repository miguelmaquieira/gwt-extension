package com.imotion.transit.front.business.desktop.client.presenter;
...
public abstract class TRANSBusBasePresenter<T extends AEGWTCompositePanelLoggedViewDisplay> extends AEGWTBaseLoggedPresenter<T> implements AEGWTHasNavigationEventHandlers {

	
	public TRANSBusBasePresenter(T view) {
		super(view);
	}
