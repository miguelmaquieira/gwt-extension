...
public interface DSLAMBUIServiceIdConstant extends AEMFTIBusinessServiceIdConstant {
	...
	//NODE
	String CTE_CRONIO_BU_SRV_NODE_ID					= "SRV_BUS_NODE";
	String CTE_CRONIO_BU_SRV_NODE_PREFIX				= CTE_CRONIO_BU_SRV_NODE_ID 		+ AEMFTIBusinessConstant.CTE_MFT_AE_BUS_SERVICE_ID_SEPARATOR;
	String CTE_CRONIO_BU_SRV_PROJECT_ADD_NODE_ID		= CTE_CRONIO_BU_SRV_NODE_PREFIX	+ CRONIOBUINodeBusinessServiceConstants.METHOD_ADD_NODE;
	String CTE_CRONIO_BU_SRV_PROJECT_GET_ALL_NODES_ID	= CTE_CRONIO_BU_SRV_NODE_PREFIX	+ CRONIOBUINodeBusinessServiceConstants.METHOD_GET_ALL_NODES;
	String CTE_CRONIO_BU_SRV_PROJECT_UPDATE_NODE_ID		= CTE_CRONIO_BU_SRV_NODE_PREFIX	+ CRONIOBUINodeBusinessServiceConstants.METHOD_UPDATE_NODE;
	String CTE_CRONIO_BU_SRV_PROJECT_REMOVE_NODE_ID		= CTE_CRONIO_BU_SRV_NODE_PREFIX	+ CRONIOBUINodeBusinessServiceConstants.METHOD_REMOVE_NODE;
