...
public interface CRONIOBUIConfiguration {
	 
	 //CFG.CRONIO
	 public static String CTE_CRONIO_CONFIG_PREFIX = AEMFTIConfigurationConstant.CTE_MFT_AE_CORE_ENTO_CONFIGURACION_PREFIJO_VARIABLES_CONFIGURACION
